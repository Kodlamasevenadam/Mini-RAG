...
# Veri tabanı
documents = [
    "Türk kahvesi cezvede yapılır.",
    "Espresso, basınçlı sıcak su ile hazırlanır.",
    "Çay demlemek için su kaynatılır.",
    "Latte, espresso ve süt karışımıdır.",
    "Filtre kahve demleme yöntemleri çeşitlidir."
]
